        ...
        <div class="mt-12 flex flex-col items-center">
          ...
          <div class="w-full flex-1 mt-8">
            ...
            <input
                ...
                type="text" name="name" placeholder="ex: Hussein Hammour, Hares Saade" 
                value="{{old('name')}}"
              ...
              @if ($errors->has('password'))
                ...
                @endif
                <input name="password_confirmation"                 class="w-full px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white mt-5" type="password" placeholder="Confirm Password" />
                ...
                <div style="gap: 12px;display: flex;margin-top: 16px;">
                    ...
                    <label for="PreferN">Perfer not to say</label>
                </div>
                ...
                <input type="text" name="phonenumber" placeholder="Phone number: 05000000"value="{{old('phonenumber')}}" style="padding: 5px;border-width: 3px;width: 320px;margin-top: 17px;border-radius: 5px;">
                @if($errors->has('phonenumber'))
                <span class="Error-msg" role="alert" style="margin-bottom: 10px;">
